...
def U_net_pyramid(inputs):
    ...
    c1=Conv2D(16,(3,3), activation="elu", kernel_initializer="he_normal",padding="same")(s)
    c1=Dropout(0.1)(c1)
    c1_s=Conv2D(8,(1,1),activation='elu', kernel_initializer="he_normal",padding="same")(c1)
    c1_m=Conv2D(8,(3,3),activation='elu', kernel_initializer="he_normal",padding="same")(c1)
    c1_l = Conv2D(8, (5, 5), activation='elu', kernel_initializer="he_normal", padding="same")(c1)
    c1=Concatenate([c1_s,c1_m,c1_l])
    p1=MaxPooling2D((2,2))(c1)

    c2=Conv2D(32,(3,3), activation="elu", kernel_initializer="he_normal",padding="same")(p1)
    c2=Dropout(0.1)(c2)
    c2_s = Conv2D(16, (1,1), activation='elu', kernel_initializer="he_normal", padding="same")(c2)
    c2_m = Conv2D(16, (3,3), activation='elu', kernel_initializer="he_normal", padding="same")(c2)
    c2_l = Conv2D(16, (5, 5), activation='elu', kernel_initializer="he_normal", padding="same")(c2)
    c2 = Concatenate([c2_s, c2_m, c2_l])
    p2=MaxPooling2D((2,2))(c2)

    c3=Conv2D(64,(3,3), activation="elu", kernel_initializer="he_normal",padding="same")(p2)
    c3=Dropout(0.1)(c3)
    c3_s = Conv2D(32, (1,1), activation='elu', kernel_initializer="he_normal", padding="same")(c3)
    c3_m = Conv2D(32, (3,3), activation='elu', kernel_initializer="he_normal", padding="same")(c3)
    c3_l = Conv2D(32, (5, 5), activation='elu', kernel_initializer="he_normal", padding="same")(c3)
    c3 = Concatenate([c3_s, c3_m, c3_l])
    p3=MaxPooling2D((2,2))(c3)

    c4=Conv2D(128,(3,3), activation="elu", kernel_initializer="he_normal",padding="same")(p3)
    c4=Dropout(0.1)(c4)
    c4_s = Conv2D(64, (1,1), activation='elu', kernel_initializer="he_normal", padding="same")(c4)
    c4_m = Conv2D(64, (3,3), activation='elu', kernel_initializer="he_normal", padding="same")(c4)
    c4_l = Conv2D(64, (5, 5),activation='elu', kernel_initializer="he_normal", padding="same")(c4)
